...
from ..utils.secure_cache import SecureCacheManager
...
class UserSessionManager:
    ...
    def save_conversation(self, role: str, content: str, metadata: Dict = None):
        """Alias for add_conversation for backward compatibility"""
        return self.add_conversation(role, content, metadata)

...
class QueryAnalyzer:
    ...
    def _llm_analyze_query(self, query: str, context: str) -> Dict[str, Any]:
        ...
        system_prompt = """You are AI Helper Agent v2.0.1 created by Meet Solanki (AIML Student). You are an AI assistant that analyzes user queries to determine if they would benefit from internet search.
